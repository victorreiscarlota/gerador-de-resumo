...
output_txt_full_path = "TXT/Resumos_Redes_Computadores3.txt"
...
output_pdf_full_path = "PDF/Resumos_Redes_Computadores3.pdf"
...
print("Arquivos .txt, .pdf e RESUMO.md gerados com sucesso no diretório!")
